...
interests with other users who have read the articles. Similar users are 
...
Recently, explore/exploit is a popular strategy~\cite{Agarwal:2013:CRW:2461256.2461277,Agarwal:2013:RIU:2512875.2517150,Li:2010:CAP:1772690.1772758}. These methods are useful for a single stream, but not scalable for multiple semantic streams.  To design a recommendation system we must consider system latency.  But we used the idea of exploration bucket to collect unbiased training data in Phase 2.
